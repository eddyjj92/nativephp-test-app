...
interface BeneficiaryMunicipality {
    id: number;
    name: string;
    province_id: number;
    province: {
...
interface Beneficiary {
    ...
    municipality: BeneficiaryMunicipality;
}
...
const form = useForm({
    ...
    identity_number: props.beneficiary.identity_number,
...
watch(selectedProvinceId, (newVal, oldVal) => {
    if (oldVal !== null && newVal !== oldVal) {
        form.municipality_id = null as any;
    }
});
