...
import { ChevronLeft, Cookie } from 'lucide-vue-next';
...
<template>
    <Head title="Políticas de Cookies - Compay Market" />
        ...
        >
            ...
            <header class="fixed top-[calc(var(--inset-top,0px)+100px)] left-0 right-0 z-40 bg-slate-50 pb-2 pt-3 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between px-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-lg font-bold">Políticas de Cookies</h1>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 px-4 pb-4 pt-[calc(var(--inset-top,0px)+60px)]">
                ...
                <div class="flex flex-col items-center pb-6 text-center">
                    <div class="flex size-16 items-center justify-center rounded-full bg-orange-50 dark:bg-orange-900/20">
                        <Cookie class="size-8 text-orange-600 dark:text-orange-400" />
                    </div>
                    <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                        Cómo usamos las cookies en nuestro sitio
                    </p>
                </div>
                ...
                >
                    <div
                        v-if="settings.cookies_policies"
                        ...
                        v-html="settings.cookies_policies"
                    />
                    <div v-else class="py-8 text-center">
                        <Cookie class="mx-auto size-12 text-slate-300 dark:text-slate-600" />
                        <p class="mt-3 text-slate-500 dark:text-slate-400">
                            Las políticas de cookies no están disponibles en este momento.
                        </p>
                    </div>
                </div>

                <!-- Info Card -->
                <div class="mt-6 rounded-2xl bg-orange-50 p-4 dark:bg-orange-900/20">
                    <h4 class="font-semibold text-orange-800 dark:text-orange-300">
                        ¿Qué son las cookies?
                    </h4>
                    <p class="mt-1 text-sm text-orange-700 dark:text-orange-400">
                        Las cookies son pequeños archivos de texto que se almacenan en tu
                        dispositivo para mejorar tu experiencia de navegación.
                    </p>
                </div>
            </main>
        </div>
